<?php
// Nova Subcategories Toggle - Universal toggle using include
// Session management and database connection
include '../inc/inc_nova_session.php';

// Set parameters for universal toggle
$toggle_table = 'ns_subcategories';
$toggle_id_field = 'id_subcategory';
$toggle_id_value = isset($_GET['id']) ? $_GET['id'] : 0;
$toggle_success_session = 'subcat_success';
