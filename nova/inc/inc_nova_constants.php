...
// DATE FORMAT
// ========================================
// Auto from language: IT=european (d-m-Y), EN=american (m-d-Y)
$_date_formats = ['it' => 'd-m-Y', 'en' => 'm-d-Y'];
define('NOVA_DATE_FORMAT', $_date_formats[$nova_settings['nova_lang'] ?? 'it'] ?? 'd-m-Y');
